...
> **Read this file + `docs/PLAN.md` (contracts) + `packages/substrate` + `packages/scenarios` (implementation). You do NOT need to read other units' files.** Spec: `apps/05-simulation/SPEC.md`.
>
